module ShareInvitationService
  ...
  def self.send_corporate_invitation(corporate_contact, corporate_admin, account_type = "client")
    if corporate_admin.present? && corporate_contact.emailaddress =~ MailService.mail_regexp
      ...
      ShareInvitationMailer.corporate_user(corporate_contact, corporate_admin, account_type).deliver_now
